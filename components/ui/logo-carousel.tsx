...
function LogoCarousel({ columnCount = 2 }: { columnCount?: number }) {
  ...
  const allLogos: Logo[] = useMemo(
    () => [
      { name: "IIT", id: 1, img: IITJAMMULOGO },
      { name: "AIIMS", id: 2, img: AIIMSJAMMULOGO },
      { name: "UNI", id: 3, img: UNIJAMMULOGO },
      { name: "MIET", id: 4, img: MIETJAMMULOGO },
    ],
    []
  )
  ...
  }, [allLogos, columnCount]) // Added columnCount to dependency array
